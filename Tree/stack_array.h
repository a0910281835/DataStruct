...
extern void memcpyInStack(PSTACK_ARRAY_T pStackArray, void *beCpyAdd, int arrayIdx, size_t sizeofSpecialObj);
extern NUM_T SizeStack(PSTACK_ARRAY_T pStackArray);
extern void PushStack(PSTACK_ARRAY_T pStackArray, void *pInputObj, size_t sizeofSpecialObj);
/*
